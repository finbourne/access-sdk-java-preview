...
Welcome and thank you for considering contributing to access-sdk-java-preview.  We're delighted to have you as part of our community.
...
We have open sourced access-sdk-java to help make it easy for you to use LUSID and welcome contributions from our community. There are many ways to contribute, from writing code samples, improving the documentation, submitting bug reports and feature requests to writing code which can be incorporated into access-sdk-java-preview itself. This section guides you through submitting a contribution.
...
If you think you have found a bug, first make sure you are testing against the latest version of access-sdk-java-preview as your issue may have already been fixed. Also search all open and closed issues to see if your issue has already been answered.
