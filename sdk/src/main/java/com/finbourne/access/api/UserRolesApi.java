...
public class UserRolesApi {
     ...
     * @param userRoleCreationRequest Dto of the user-role to be created. (required)
    ...
    public okhttp3.Call createUserRoleCall(UserRoleCreationRequest userRoleCreationRequest, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("X-LUSID-SDK-Version", "0.0.1950");
    ...
    /**
     * [EXPERIMENTAL] GetUserRole: Gets a user-role (asynchronously)
     * Gets an identified user-role.
     * @param userid Id of the user-role to get (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param userid Id of the user-role to get (required)
     * @param userRoleUpdateRequest Dto of the user-role to be updated. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
